...
MyTop: main.o stat_manager.o process_list.o utils.o fifo_utils.o mergesort.o linked_list.o src/fifo_utils.h src/utils.h src/stat_manager.h src/mergesort.h src/process_list.h src/linked_list.h subsystem
	gcc -g -o MyTop main.o stat_manager.o process_list.o utils.o fifo_utils.o linked_list.o mergesort.o
...
process_list.o: src/process_list.c src/fifo_utils.h src/utils.h src/process_list.h src/linked_list.h src/mergesort.h
